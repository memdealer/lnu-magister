...
const (
	Logger_LogData_FullMethodName = "/logdata.Logger/LogData"
)
...
type LoggerClient interface {
	...
	LogData(ctx context.Context, in *LogRequest, opts ...grpc.CallOption) (*LogResponse, error)
}
...
func (c *loggerClient) LogData(ctx context.Context, in *LogRequest, opts ...grpc.CallOption) (*LogResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(LogResponse)
	err := c.cc.Invoke(ctx, Logger_LogData_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type LoggerServer interface {
	// RPC для запису нового рядка
	LogData(context.Context, *LogRequest) (*LogResponse, error)
...
func (UnimplementedLoggerServer) LogData(context.Context, *LogRequest) (*LogResponse, error) {
...
func _Logger_LogData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(LogRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LoggerServer).LogData(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Logger_LogData_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LoggerServer).LogData(ctx, req.(*LogRequest))
	}
...
var Logger_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "logdata.Logger",
	HandlerType: (*LoggerServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "LogData",
			Handler:    _Logger_LogData_Handler,
		},
	},
